...
import { BookingWhatsAppEnhancer } from '../components/booking-whatsapp-enhancer';
import { CheckoutAddonsEnhancer } from '../components/checkout-addons-enhancer';
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="id" className={inter.variable}><body><AppShell>{children}</AppShell><BookingWhatsAppEnhancer/><CheckoutAddonsEnhancer/></body></html>; }
