...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const required:Record<string,string>={'/pos':'booking.manage','/employees':'employee.read','/projects':'project.read','/tasks':'task.read','/crm/customers':'customer.read','/packages':'package.read','/service-products':'package.read','/package-reviews':'package.read','/asset-knowledge':'knowledge.read','/media-library':'media.read','/vendors':'vendor.read','/finance/cashflow':'payment.read','/sales/quotations':'lead.read','/bookings':'booking.read','/operations/trips':'trip.read','/operations/open-trips':'trip.read','/finance/invoices':'invoice.read','/reports':'dashboard.owner','/archives':'archive.read','/content':'content.read'};
