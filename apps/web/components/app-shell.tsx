...
export function AppShell({ children }: {
    ...
    return (<div className="erpShell">
      <header className="erpMobileHeader">
        ...
        <Link href="/dashboard" className="erpMobileBrand">BATAM TRAVELLING</Link>
      </header>
